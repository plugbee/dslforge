...
import org.eclipse.xtext.example.domainmodel.web.module.WebDomainmodelStandaloneSetup;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.xtext.example.domainmodel.web"; //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		addImageFilePath(DomainmodelImageProvider.FILE);
		addImageFilePath(DomainmodelImageProvider.WIZARD);
	}
