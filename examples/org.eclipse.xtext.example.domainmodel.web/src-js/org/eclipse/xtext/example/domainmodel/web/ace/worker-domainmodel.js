...
define('ace/mode/domainmodel_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/domainmodel/domainmodelparse'], function(require, exports, module) {
	...
	importScripts("../parser/DomainmodelLexer.js");
	importScripts("../parser/DomainmodelParser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new DomainmodelLexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new DomainmodelParser(tstream);
		    try {
