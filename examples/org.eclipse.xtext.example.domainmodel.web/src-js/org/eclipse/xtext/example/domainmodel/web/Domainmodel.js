	...
	rwt.qx.Class.define("org.eclipse.xtext.example.domainmodel.web.editor.widget.Domainmodel", {
		...
		members : {
			...
			createEditor : function() {
				...
				var modePath = 'rwt-resources/src-js/org/eclipse/xtext/example/domainmodel/web/ace';
				...
				if (editor != null) {
			        ...
			        ace.config.loadModule("ace/ext/language_tools", function (module) {
			        	...
			        	session.id = self.url;
						session.setMode("ace/mode/domainmodel");
						...
						editor.setTheme("ace/theme/domainmodel");
			        });
