...
org.antlr.lang.augmentObject(InternalMyDslParser.prototype, {
    ...
    rule_Model: function() {
        ...
        try {
            ...
            EOF1=this.match(this.input,EOF,InternalMyDslParser.FOLLOW_EOF_in_rule_Model60); 
    ...
    rule_Greeting: function() {
        ...
        try {
            ...
            name=this.match(this.input,ID,InternalMyDslParser.FOLLOW_ID_in_rule_Greeting74); 
            name_tree = this.adaptor.create(name);
            this.adaptor.addChild(root_0, name_tree);

            char_literal3=this.match(this.input,10,InternalMyDslParser.FOLLOW_10_in_rule_Greeting76); 
...
org.antlr.lang.augmentObject(InternalMyDslParser, {
    ...
    FOLLOW_rule_Greeting_in_rule_Model57: new org.antlr.runtime.BitSet([0x00000200, 0x00000000]),
    FOLLOW_EOF_in_rule_Model60: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_9_in_rule_Greeting70: new org.antlr.runtime.BitSet([0x00000010, 0x00000000]),
    FOLLOW_ID_in_rule_Greeting74: new org.antlr.runtime.BitSet([0x00000400, 0x00000000]),
    FOLLOW_10_in_rule_Greeting76: new org.antlr.runtime.BitSet([0x00000002, 0x00000000])
});
