 ...
 * @Generated
 */
package org.xtext.example.mydsl.web.internal;
...
import org.xtext.example.mydsl.web.module.WebMyDslStandaloneSetup;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.xtext.example.mydsl.web"; //$NON-NLS-1$
	...
	protected void initializeImageRegistry(ImageRegistry reg) {
		addImageFilePath(MyDslImageProvider.FILE);
		addImageFilePath(MyDslImageProvider.WIZARD);
	}
