...
define('ace/mode/play_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/play/playparse'], function(require, exports, module) {

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var playparse = require("../mode/play/playparse");

importScripts("../parser/antlr-all-min.js");
importScripts("../parser/PlayLexer.js");
importScripts("../parser/PlayParser.js");
...
(function() {
    ...
    this.onUpdate = function() {
	    ...
	    lexer = new PlayLexer(cstream);
	    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
	    parser = new PlayParser(tstream);
	    try {
	    	parser.rule_PlayModel();
	    } catch(err) {
...
define('ace/mode/play/playparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'playparse', function (exports) {
