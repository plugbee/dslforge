...
public class DomainmodelStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.example.DomainmodelRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/example/Domainmodel")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/example/Domainmodel", org.xtext.example.domainmodel.DomainmodelPackage.eINSTANCE);
	}
