 ...
 */
(function() {
	rap.registerTypeHandler("org.eclipse.sphinx.examples.xtext.hummingbird.web.editor.widget.Hummingbird", {
		factory : function(properties) {
			return new org.eclipse.sphinx.examples.xtext.hummingbird.web.editor.widget.Hummingbird(properties);
		},
		destructor : "destroy",
	...
	rwt.qx.Class.define("org.eclipse.sphinx.examples.xtext.hummingbird.web.editor.widget.Hummingbird", {
		...
		members : {
			...
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/org/eclipse/sphinx/examples/xtext/hummingbird/web/ace';
				...
				var modePath = 'rwt-resources/src-js/org/eclipse/sphinx/examples/xtext/hummingbird/web/ace';
				...
				if (editor != null) {
			        ...
			        ace.config.loadModule("ace/ext/language_tools", function (module) {
			        	...
			        	session.id = self.url;
						session.setMode("ace/mode/hummingbird");
						...
						editor.setTheme("ace/theme/hummingbird");
			        });
