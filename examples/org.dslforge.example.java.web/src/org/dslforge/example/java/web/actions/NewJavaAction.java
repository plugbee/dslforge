package org.dslforge.example.java.web.actions;
...
public class NewJavaAction extends WorkbenchWindowActionDelegate  {
	...
	public void run(IAction action) {		
		...
		if (!selection.isEmpty()) {
			...
			NewFileWizard wizard = new NewFileWizard(firstElement.toString(), "Java", "dmodel");
			wizard.init(getWindow().getWorkbench(), (IStructuredSelection)selection);
			wizard.setWindowTitle("New Java Model");
