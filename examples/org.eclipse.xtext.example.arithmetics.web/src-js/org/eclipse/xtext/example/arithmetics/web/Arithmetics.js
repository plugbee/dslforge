 ...
 */
(function() {
	rap.registerTypeHandler("org.eclipse.xtext.example.arithmetics.web.editor.widget.Arithmetics", {
		factory : function(properties) {
			return new org.eclipse.xtext.example.arithmetics.web.editor.widget.Arithmetics(properties);
		},
		destructor : "destroy",
	...
	rwt.qx.Class.define("org.eclipse.xtext.example.arithmetics.web.editor.widget.Arithmetics", {
		...
		members : {
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/org/eclipse/xtext/example/arithmetics/web/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/org/eclipse/xtext/example/arithmetics/web/ace';
				ace.require("ace/config").set("themePath", themePath);
				var modePath = 'rwt-resources/src-js/org/eclipse/xtext/example/arithmetics/web/ace';
				...
				if (editor != null) {
					...
					ace.config.loadModule("ace/ext/language_tools", function (module) {
						editor.getSession().setMode("ace/mode/arithmetics");
						...
						editor.setTheme("ace/theme/arithmetics");
