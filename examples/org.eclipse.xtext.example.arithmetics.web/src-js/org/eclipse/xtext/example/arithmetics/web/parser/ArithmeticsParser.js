// $ANTLR 3.3 avr. 19, 2016 01:13:22 D:\\git\\dslforge\\examples\\org.eclipse.xtext.example.arithmetics.web\\src-js\\org\\eclipse\\xtext\\example\\arithmetics\\web\\parser\\Arithmetics.g 2016-05-08 20:57:38
...
org.antlr.lang.augmentObject(ArithmeticsParser.prototype, {
    ...
    rule_Module: function() {
        ...
        try {
            ...
            string_literal1=this.match(this.input,10,ArithmeticsParser.FOLLOW_10_in_rule_Module65); 
            string_literal1_tree = this.adaptor.create(string_literal1);
            this.adaptor.addChild(root_0, string_literal1_tree);

            name=this.match(this.input,ID,ArithmeticsParser.FOLLOW_ID_in_rule_Module69); 
            ...
            do {
                ...
                case 1 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Import_in_rule_Module75);
            ...
            do {
                ...
                if ( ((LA2_0>=ID && LA2_0<=NUMBER)||(LA2_0>=12 && LA2_0<=13)) ) {
                    alt2=1;
                }
                ...
                case 1 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Statement_in_rule_Module83);
            ...
            EOF2=this.match(this.input,EOF,ArithmeticsParser.FOLLOW_EOF_in_rule_Module87); 
    ...
    rule_Import: function() {
        ...
        try {
            ...
            string_literal3=this.match(this.input,11,ArithmeticsParser.FOLLOW_11_in_rule_Import99); 
            string_literal3_tree = this.adaptor.create(string_literal3);
            this.adaptor.addChild(root_0, string_literal3_tree);

            module=this.match(this.input,ID,ArithmeticsParser.FOLLOW_ID_in_rule_Import103); 
    ...
    rule_Statement: function() {
        ...
        try {
            ...
            else if ( ((LA3_0>=ID && LA3_0<=NUMBER)||LA3_0==13) ) {
                alt3=2;
            }
            else {
                var nvae =
            ...
            switch (alt3) {
                case 1 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Definition_in_rule_Statement114);
                ...
                case 2 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Evaluation_in_rule_Statement118);
    ...
    rule_Definition: function() {
        ...
        try {
            ...
            string_literal6=this.match(this.input,12,ArithmeticsParser.FOLLOW_12_in_rule_Definition129); 
            string_literal6_tree = this.adaptor.create(string_literal6);
            this.adaptor.addChild(root_0, string_literal6_tree);

            name=this.match(this.input,ID,ArithmeticsParser.FOLLOW_ID_in_rule_Definition133); 
            name_tree = this.adaptor.create(name);
            this.adaptor.addChild(root_0, name_tree);
            ...
            switch (alt5) {
                case 1 :
                    ...
                    char_literal7=this.match(this.input,13,ArithmeticsParser.FOLLOW_13_in_rule_Definition136); 
                    char_literal7_tree = this.adaptor.create(char_literal7);
                    this.adaptor.addChild(root_0, char_literal7_tree);

                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_DeclaredParameter_in_rule_Definition140);
                    ...
                    do {
                        ...
                        case 1 :
                            ...
                            char_literal8=this.match(this.input,14,ArithmeticsParser.FOLLOW_14_in_rule_Definition143); 
                            char_literal8_tree = this.adaptor.create(char_literal8);
                            this.adaptor.addChild(root_0, char_literal8_tree);

                            this.pushFollow(ArithmeticsParser.FOLLOW_rule_DeclaredParameter_in_rule_Definition147);
                            args=this.rule_DeclaredParameter();
                    ...
                    char_literal9=this.match(this.input,15,ArithmeticsParser.FOLLOW_15_in_rule_Definition151); 
            ...
            char_literal10=this.match(this.input,16,ArithmeticsParser.FOLLOW_16_in_rule_Definition156); 
            char_literal10_tree = this.adaptor.create(char_literal10);
            this.adaptor.addChild(root_0, char_literal10_tree);

            this.pushFollow(ArithmeticsParser.FOLLOW_rule_Expression_in_rule_Definition160);
            expr=this.rule_Expression();

            this.state._fsp--;

            this.adaptor.addChild(root_0, expr.getTree());
            char_literal11=this.match(this.input,17,ArithmeticsParser.FOLLOW_17_in_rule_Definition162); 
    ...
    rule_DeclaredParameter: function() {
        ...
        try {
            ...
            name=this.match(this.input,ID,ArithmeticsParser.FOLLOW_ID_in_rule_DeclaredParameter175); 
            name_tree = this.adaptor.create(name);
            this.adaptor.addChild(root_0, name_tree);
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Definition_in_rule_AbstractDefinition186);
                ...
                case 2 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_DeclaredParameter_in_rule_AbstractDefinition190);
    ...
    rule_Evaluation: function() {
        ...
        try {
            ...
            this.pushFollow(ArithmeticsParser.FOLLOW_rule_Expression_in_rule_Evaluation203);
            expression=this.rule_Expression();

            this.state._fsp--;

            this.adaptor.addChild(root_0, expression.getTree());
            char_literal14=this.match(this.input,17,ArithmeticsParser.FOLLOW_17_in_rule_Evaluation205); 
    ...
    rule_Expression: function() {
        ...
        try {
            ...
            this.pushFollow(ArithmeticsParser.FOLLOW_rule_Addition_in_rule_Expression216);
    ...
    rule_Addition: function() {
        ...
        try {
            ...
            this.pushFollow(ArithmeticsParser.FOLLOW_rule_Multiplication_in_rule_Addition228);
            ...
            do {
                ...
                case 1 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Multiplication_in_rule_Addition243);
    ...
    rule_Multiplication: function() {
        ...
        try {
            ...
            this.pushFollow(ArithmeticsParser.FOLLOW_rule_PrimaryExpression_in_rule_Multiplication257);
            ...
            do {
                ...
                case 1 :
                    ...
                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_PrimaryExpression_in_rule_Multiplication272);
    ...
    // D:\\git\\dslforge\\examples\\org.eclipse.xtext.example.arithmetics.web\\src-js\\org\\eclipse\\xtext\\example\\arithmetics\\web\\parser\\Arithmetics.g:83:1: rule_PrimaryExpression : ( '(' rule_Expression ')' | value= NUMBER | func= ID ( '(' args+= rule_Expression ( ',' args+= rule_Expression )* ')' )? );
    ...
    rule_PrimaryExpression: function() {
        ...
        try {
            // D:\\git\\dslforge\\examples\\org.eclipse.xtext.example.arithmetics.web\\src-js\\org\\eclipse\\xtext\\example\\arithmetics\\web\\parser\\Arithmetics.g:83:24: ( '(' rule_Expression ')' | value= NUMBER | func= ID ( '(' args+= rule_Expression ( ',' args+= rule_Expression )* ')' )? )
            var alt11=3;
            ...
            switch (alt11) {
                case 1 :
                    ...
                    char_literal20=this.match(this.input,13,ArithmeticsParser.FOLLOW_13_in_rule_PrimaryExpression286); 
                    char_literal20_tree = this.adaptor.create(char_literal20);
                    this.adaptor.addChild(root_0, char_literal20_tree);

                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Expression_in_rule_PrimaryExpression288);
                    rule_Expression21=this.rule_Expression();

                    this.state._fsp--;

                    this.adaptor.addChild(root_0, rule_Expression21.getTree());
                    char_literal22=this.match(this.input,15,ArithmeticsParser.FOLLOW_15_in_rule_PrimaryExpression290); 
                    ...
                    break;
                case 2 :
                    // D:\\git\\dslforge\\examples\\org.eclipse.xtext.example.arithmetics.web\\src-js\\org\\eclipse\\xtext\\example\\arithmetics\\web\\parser\\Arithmetics.g:85:3: value= NUMBER
                    root_0 = this.adaptor.nil();

                    value=this.match(this.input,NUMBER,ArithmeticsParser.FOLLOW_NUMBER_in_rule_PrimaryExpression298); 
                ...
                case 3 :
                    ...
                    func=this.match(this.input,ID,ArithmeticsParser.FOLLOW_ID_in_rule_PrimaryExpression306); 
                    ...
                    switch (alt10) {
                        case 1 :
                            ...
                            char_literal23=this.match(this.input,13,ArithmeticsParser.FOLLOW_13_in_rule_PrimaryExpression309); 
                            char_literal23_tree = this.adaptor.create(char_literal23);
                            this.adaptor.addChild(root_0, char_literal23_tree);

                            this.pushFollow(ArithmeticsParser.FOLLOW_rule_Expression_in_rule_PrimaryExpression313);
                            ...
                            do {
                                ...
                                case 1 :
                                    ...
                                    char_literal24=this.match(this.input,14,ArithmeticsParser.FOLLOW_14_in_rule_PrimaryExpression316); 
                                    char_literal24_tree = this.adaptor.create(char_literal24);
                                    this.adaptor.addChild(root_0, char_literal24_tree);

                                    this.pushFollow(ArithmeticsParser.FOLLOW_rule_Expression_in_rule_PrimaryExpression320);
                                    args=this.rule_Expression();
                            ...
                            char_literal25=this.match(this.input,15,ArithmeticsParser.FOLLOW_15_in_rule_PrimaryExpression324); 
...
// public class variables
org.antlr.lang.augmentObject(ArithmeticsParser, {
    tokenNames: ["<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "NUMBER", "STRING", "COMMENT", "WS", "INT", "'module'", "'import'", "'def'", "'('", "','", "')'", "':'", "';'", "'+'", "'-'", "'*'", "'/'"],
    FOLLOW_10_in_rule_Module65: new org.antlr.runtime.BitSet([0x00000010, 0x00000000]),
    FOLLOW_ID_in_rule_Module69: new org.antlr.runtime.BitSet([0x00003830, 0x00000000]),
    FOLLOW_rule_Import_in_rule_Module75: new org.antlr.runtime.BitSet([0x00003830, 0x00000000]),
    FOLLOW_rule_Statement_in_rule_Module83: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_EOF_in_rule_Module87: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_11_in_rule_Import99: new org.antlr.runtime.BitSet([0x00000010, 0x00000000]),
    FOLLOW_ID_in_rule_Import103: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_Definition_in_rule_Statement114: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_Evaluation_in_rule_Statement118: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_12_in_rule_Definition129: new org.antlr.runtime.BitSet([0x00000010, 0x00000000]),
    FOLLOW_ID_in_rule_Definition133: new org.antlr.runtime.BitSet([0x00012000, 0x00000000]),
    FOLLOW_13_in_rule_Definition136: new org.antlr.runtime.BitSet([0x00000010, 0x00000000]),
    FOLLOW_rule_DeclaredParameter_in_rule_Definition140: new org.antlr.runtime.BitSet([0x0000C000, 0x00000000]),
    FOLLOW_14_in_rule_Definition143: new org.antlr.runtime.BitSet([0x00000010, 0x00000000]),
    FOLLOW_rule_DeclaredParameter_in_rule_Definition147: new org.antlr.runtime.BitSet([0x0000C000, 0x00000000]),
    FOLLOW_15_in_rule_Definition151: new org.antlr.runtime.BitSet([0x00010000, 0x00000000]),
    FOLLOW_16_in_rule_Definition156: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_rule_Expression_in_rule_Definition160: new org.antlr.runtime.BitSet([0x00020000, 0x00000000]),
    FOLLOW_17_in_rule_Definition162: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_rule_DeclaredParameter175: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_Definition_in_rule_AbstractDefinition186: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_DeclaredParameter_in_rule_AbstractDefinition190: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_Expression_in_rule_Evaluation203: new org.antlr.runtime.BitSet([0x00020000, 0x00000000]),
    FOLLOW_17_in_rule_Evaluation205: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_Addition_in_rule_Expression216: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_rule_Multiplication_in_rule_Addition228: new org.antlr.runtime.BitSet([0x000C0002, 0x00000000]),
    FOLLOW_set_in_rule_Addition231: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_rule_Multiplication_in_rule_Addition243: new org.antlr.runtime.BitSet([0x000C0002, 0x00000000]),
    FOLLOW_rule_PrimaryExpression_in_rule_Multiplication257: new org.antlr.runtime.BitSet([0x00300002, 0x00000000]),
    FOLLOW_set_in_rule_Multiplication260: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_rule_PrimaryExpression_in_rule_Multiplication272: new org.antlr.runtime.BitSet([0x00300002, 0x00000000]),
    FOLLOW_13_in_rule_PrimaryExpression286: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_rule_Expression_in_rule_PrimaryExpression288: new org.antlr.runtime.BitSet([0x00008000, 0x00000000]),
    FOLLOW_15_in_rule_PrimaryExpression290: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_NUMBER_in_rule_PrimaryExpression298: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_rule_PrimaryExpression306: new org.antlr.runtime.BitSet([0x00002002, 0x00000000]),
    FOLLOW_13_in_rule_PrimaryExpression309: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_rule_Expression_in_rule_PrimaryExpression313: new org.antlr.runtime.BitSet([0x0000C000, 0x00000000]),
    FOLLOW_14_in_rule_PrimaryExpression316: new org.antlr.runtime.BitSet([0x00003030, 0x00000000]),
    FOLLOW_rule_Expression_in_rule_PrimaryExpression320: new org.antlr.runtime.BitSet([0x0000C000, 0x00000000]),
    FOLLOW_15_in_rule_PrimaryExpression324: new org.antlr.runtime.BitSet([0x00000002, 0x00000000])
});
