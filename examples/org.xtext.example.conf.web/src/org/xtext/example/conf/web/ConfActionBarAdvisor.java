...
import org.xtext.example.conf.web.actions.ConfigureSettingsAction;
import org.xtext.example.conf.web.actions.OpenURIAction;

/**
 * Creates, adds and disposes actions for the menus and action bars of
 * each workbench window.
 */
public class ConfActionBarAdvisor extends ActionBarAdvisor {

	public ConfActionBarAdvisor(IActionBarConfigurer configurer) {
		super(configurer);
	}
	...
	protected IMenuManager createToolsMenu(IWorkbenchWindow window) {
		IMenuManager menu = new MenuManager("Tools",
				IWorkbenchActionConstants.M_EDIT);
		...
		IAction generate = new org.xtext.example.conf.web.actions.GenerateAction();
