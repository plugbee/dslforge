...
define('ace/mode/conf_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/conf/confparse'], function(require, exports, module) {

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var confparse = require("../mode/conf/confparse");

importScripts("../parser/antlr-all-min.js");
importScripts("../parser/InternalConfLexer.js");
importScripts("../parser/InternalConfParser.js");
...
(function() {
    ...
    this.onUpdate = function() {
	    ...
	    lexer = new InternalConfLexer(cstream);
	    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
	    parser = new InternalConfParser(tstream);
	    var foo = parser.model();
	    if (msg_error!=null) {
...
define('ace/mode/domainmodel/domainmodelparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'domainmodelparse', function (exports) {
  ...
  function end(_input) {
    ...
    if (locations.length > 0)
      throw new Error('Location tracking failed. This is most likely a bug in domainmodelparse');
