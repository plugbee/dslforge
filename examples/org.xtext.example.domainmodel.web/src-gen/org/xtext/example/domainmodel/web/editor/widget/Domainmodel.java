...
public class Domainmodel extends BasicText {
	...
	protected void setupClient() {
		...
		languageResources.add(new Path("src-js/org/xtext/example/domainmodel/web/ace/theme-eclipse.js"));
		languageResources.add(new Path("src-js/org/xtext/example/domainmodel/web/ace/snippets/domainmodel.js"));		
		languageResources.add(new Path("src-js/org/xtext/example/domainmodel/web/ace/mode-domainmodel.js"));
		languageResources.add(new Path("src-js/org/xtext/example/domainmodel/web/ace/worker-domainmodel.js"));
