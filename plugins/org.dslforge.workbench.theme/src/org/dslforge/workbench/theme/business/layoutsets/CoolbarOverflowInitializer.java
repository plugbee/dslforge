...
public class CoolbarOverflowInitializer implements ILayoutSetInitializer {
	...
	public void initializeLayoutSet(final LayoutSet layoutSet) {
		...
		layoutSet.addImagePath(ILayoutSetConstants.OVERFLOW_BG, path
				+ "toolbar_overflow_layer_bg.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.OVERFLOW_RIGHT, path
				+ "toolbar_overflow_layer_right.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.OVERFLOW_WAVE, path
				+ "header_wave_layer.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.OVERFLOW_ARROW, path
