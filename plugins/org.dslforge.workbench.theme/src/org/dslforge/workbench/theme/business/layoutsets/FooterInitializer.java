...
public class FooterInitializer implements ILayoutSetInitializer {
	...
	public void initializeLayoutSet(final LayoutSet layoutSet) {
		...
		layoutSet.addImagePath(ILayoutSetConstants.FOOTER_LEFT, path
				+ "footer_left.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.FOOTER_BG, path
				+ "footer_bg.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.FOOTER_RIGHT, path
