...
import org.dslforge.workbench.theme.builder.FooterBuilder;
import org.dslforge.workbench.theme.builder.PerspectiveSwitcherBuilder;
import org.dslforge.workbench.theme.business.builder.HeaderBuilder;
...
public class BusinessWindowComposer implements IWindowComposer {
	...
	public Composite createWindowContents(final Shell shell,
	...
	private void setupComponents(final Shell shell,
			final IWorkbenchWindowConfigurer configurer) {
		this.shell = shell;
	...
	private void attachPageBg(final FormData fdPageBg,
			final Label menuBarBorder, final Composite menuBarComp) {
	...
	private void createFooter(final Composite pageBg) {
		...
		if (configurer.getShowStatusLine()) {
			...
			ElementBuilder footerBuilder = new FooterBuilder(footer,
					ILayoutSetConstants.SET_ID_FOOTER);
			footerBuilder.build();
	...
	private void createHeader() {
		...
		ElementBuilder headerBuilder = new HeaderBuilder(headerArea,
				ILayoutSetConstants.SET_ID_HEADER);
		headerBuilder.build();
	...
	private void createPerspectiveBar(final Composite header) {
		...
		ElementBuilder perspBuilder = new PerspectiveSwitcherBuilder(perspBar,
	...
	private void createCoolBar(final ICoolBarManager manager,
