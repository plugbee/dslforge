 ...
 ******************************************************************************/
package org.dslforge.workbench.theme.business.layoutsets;
...
public class StackInitializer implements ILayoutSetInitializer {
	...
	public void initializeLayoutSet(final LayoutSet layoutSet) {
		...
		layoutSet.addImagePath(ILayoutSetConstants.STACK_CONF_ACTIVE, path
				+ "stack_tab_conf_active.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_CONF_INACTIVE, path
				+ "stack_tab_conf_inactive.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_CONF_BG_ACTIVE, path
				+ "stack_tab_active_confarea_bg.png"); //$NON-NLS-1$
		layoutSet.addImagePath(
				ILayoutSetConstants.STACK_TAB_INACTIVE_BG_ACTIVE, path
						+ "stack_tab_inactive_bg_active.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_CONF_BG_INACTIVE, path
				+ "stack_tab_inactive_confarea_bg.png"); //$NON-NLS-1$
		layoutSet.addImagePath(
				ILayoutSetConstants.STACK_TAB_INACTIVE_RIGHT_ACTIVE, path
		...
		layoutSet.addImagePath(ILayoutSetConstants.STACK_BORDER_LEFT, path
				+ "stack_border_left.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_BORDER_RIGHT, path
				+ "stack_border_right.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_BORDER_TOP, path
				+ "stack_border_top.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_BORDER_BOTTOM, path
		...
		layoutSet.addImagePath(ILayoutSetConstants.STACK_INACTIVE_CORNER, path
		...
		layoutSet.addImagePath(ILayoutSetConstants.STACK_VIEW_TOOLBAR_BG, path
				+ "viewtoolbar_bg.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_VIEW_MENU_ICON, path
				+ "viewMenu.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_VIEW_PULLDOWN, path
				+ "viewPulldown.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.STACK_TAB_BG_ACTIVE, path
		...
		layoutSet.addPosition(ILayoutSetConstants.STACK_OVERFLOW_POSITION,
				fdOverflow);
		layoutSet.addColor(ILayoutSetConstants.STACK_BUTTON_ACTIVE,	Graphics.getColor(0, 88, 159));
		layoutSet.addColor(ILayoutSetConstants.STACK_BUTTON_INACTIVE, Graphics.getColor(148, 148, 148));
