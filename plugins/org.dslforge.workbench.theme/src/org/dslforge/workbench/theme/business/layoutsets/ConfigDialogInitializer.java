...
public class ConfigDialogInitializer implements ILayoutSetInitializer {
	...
	public void initializeLayoutSet(final LayoutSet layoutSet) {
		...
		layoutSet.addImagePath(ILayoutSetConstants.CONFIG_DIALOG_CLOSE, path + "close.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.CONFIG_DIALOG_ICON, path	+ "conf_dialog_icon.png"); //$NON-NLS-1$
	}
}
