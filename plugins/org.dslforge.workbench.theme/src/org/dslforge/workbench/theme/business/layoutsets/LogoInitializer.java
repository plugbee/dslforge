...
public class LogoInitializer implements ILayoutSetInitializer {
	...
	public void initializeLayoutSet(final LayoutSet layoutSet) {
		...
		layoutSet.addImagePath(ILayoutSetConstants.USER, path + "user.png"); //$NON-NLS-1$
		...
		fdUser.right = new FormAttachment(100, -75);
		fdUser.top = new FormAttachment(0, 32);
		layoutSet.addPosition(ILayoutSetConstants.USER_POSITION, fdUser);
	}
}
