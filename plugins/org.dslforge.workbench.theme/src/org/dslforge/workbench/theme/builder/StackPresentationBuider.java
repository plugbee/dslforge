 ...
 ******************************************************************************/
package org.dslforge.workbench.theme.builder;

import java.util.HashMap;
import java.util.Map;

import org.dslforge.workbench.theme.ILayoutSetConstants;
import org.dslforge.workbench.theme.stacks.ViewStackPresentation;
...
public class StackPresentationBuider extends ElementBuilder {
	...
	private Composite createFrame() {
		...
		fdLeft.bottom = new FormAttachment(100,
				-borderBottom.getBounds().height + 1);
		...
		fdRight.bottom = new FormAttachment(100,
				-borderBottom.getBounds().height + 1);
