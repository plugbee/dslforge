...
//import org.dslforge.workspace.jpa.IPersistencyConstants;
...
//	
//	static final Logger logger = Logger.getLogger(InternalDBService.class);
//	
//	private BundleContext context;
//	private EntityManagerFactory entityManagerFactory;
//	private static InternalDBService INSTANCE;
//
//	public static synchronized InternalDBService getInstance() {
//		if (INSTANCE == null) {
//			INSTANCE = new InternalDBService();
//		}
//		return INSTANCE;
//	}
//
//	private InternalDBService() {
//		logger.info("Starting Internal Database Service...");
//	}
//
...
//			entityManagerFactory = lookupEntityManagerFactory(IPersistencyConstants.PERSISTENCE_UNIT_NAME);
//		}
...
//				resource.setStatus(IPersistencyConstants.UNLOCKED);
//				EntityManager em = getEmf().createEntityManager();
//				em.getTransaction().begin();
...
//			return;
//		}
//		resource.setStatus(IPersistencyConstants.LOCKED);
//
//		User user = em.find(User.class, userName);
...
//
//		q = em.createQuery(
//				"update Resource r set r.status ='" + IPersistencyConstants.UNLOCKED + "' where r.path = '" + path + "'");
//		q.executeUpdate();
//		em.getTransaction().commit();
//		em.close();
//		dumpDatabase();
...
//		EntityManager em = getEmf().createEntityManager();
//		em.getTransaction().begin();
//		Query q = em.createQuery("update Resource r set r.status ='" + IPersistencyConstants.UNLOCKED
...
//			return false;
//		}
//		if (resource.getStatus().equals(IPersistencyConstants.LOCKED))
//			return true;
//		return false;
//	}
//
