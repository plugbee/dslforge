...
class GenGlobalIndexResource implements IWebProjectGenerator{
	...
	override doGenerate(EObject input, IFileSystemAccess fsa) {
		...
		fsa.generateFile(basePath + relativePath + "GlobalIndexResource.java", "src", toJava())
	}
...
public final class GlobalIndexResource implements IResource {
  ...
  public String getLocation() {
    return "src-js/«basePath»/global-index.js"; //$NON-NLS-1$
  }
