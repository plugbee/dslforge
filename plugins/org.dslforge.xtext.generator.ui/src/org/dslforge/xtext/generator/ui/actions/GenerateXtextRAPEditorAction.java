...
public class GenerateXtextRAPEditorAction extends BaseSelectionListenerAction implements IObjectActionDelegate {

	protected ISelection selection;
	
	public GenerateXtextRAPEditorAction() {
	...
	public void run(IAction action) {
		...
		settings.put("EditorType", EditorType.RAP);
		try {
	...
	private GenerateProjectOperation createGenerateProjectOperation(Map<String, Object> settings) {
		return new GenerateWebPluginProjectOperation(settings);
	}
