...
public class WebProjectGeneratorWizardPage extends WizardPage {
    ...
    final String STORE_DIRECTORIES = "WebProjectGeneratorWizard";//$NON-NLS-1$
    final String STORE_FILES = "WebProjectGeneratorWizardFiles";//$NON-NLS-1$
    final int COMBO_HISTORY_LENGTH = 5;
	static String previouslyBrowsedDirectory = "";
	static String previouslySelectedFile = "";
	...
	private void restoreWidgetValues() {			
		...
		if (settings != null) {
            restoreFromHistory(settings, STORE_DIRECTORIES, navigatorRootField);
            restoreFromHistory(settings, STORE_FILES, generatorResourceField);
		}
	...
	protected void saveWidgetValues() {
		IDialogSettings settings = getDialogSettings();
		if (settings != null) {
            saveInHistory(settings, STORE_DIRECTORIES, navigatorRootField.getText());
            saveInHistory(settings, STORE_FILES, generatorResourceField.getText());
		}
	}
