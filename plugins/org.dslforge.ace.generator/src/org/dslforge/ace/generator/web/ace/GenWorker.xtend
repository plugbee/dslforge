...
class GenWorker extends AbstractGenerator{
	...
	override doGenerate(IWebProjectFactory factory, IProgressMonitor monitor) {
		...
		grammarShortName = factory.getInput().shortName		
		entryRule = grammar.getEntryRule().toFirstLower
		factory.generateFile(defaultSlotName + basePath + relativePath, "worker-" + grammarShortName.toLowerCase + ".js", toJavaScript(), monitor)
	}
...
define('ace/mode/«grammarShortName.toLowerCase»_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/«grammarShortName.toLowerCase»/«grammarShortName.toLowerCase»parse'], function(require, exports, module) {
	...
	importScripts("../parser/«grammarShortName»Lexer.js");
	importScripts("../parser/«grammarShortName»Parser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new «grammarShortName»Lexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new «grammarShortName»Parser(tstream);
		    try {
		    	parser.«entryRule»();
		    } catch(err) {
...
define('ace/mode/«grammarShortName.toLowerCase»/«grammarShortName.toLowerCase»parse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, '«grammarShortName.toLowerCase»parse', function (exports) {
